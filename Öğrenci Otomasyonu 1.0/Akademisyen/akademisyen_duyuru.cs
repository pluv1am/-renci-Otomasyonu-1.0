...
{
    public partial class akademisyen_duyuru : Form
    {
        public akademisyen_duyuru()
        {
            InitializeComponent();
        }
        ...
        private void akademisyen_duyuru_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void akademisyen_duyuru_Resize(object sender, EventArgs e)
        {
            Invalidate();
        }

        private void akademisyen_duyuru_Load(object sender, EventArgs e)
        {

            if (akdmsyn_giris.akademisyen_bolum == "Bilgisayar Mühendisliği")
                url = "http://mf-bm.gazi.edu.tr";
            else if (akdmsyn_giris.akademisyen_bolum == "İnşaat Mühendisliği")
                url = "http://mf-im.gazi.edu.tr";
            else if (akdmsyn_giris.akademisyen_bolum == "Makine Mühendisliği")
                url = "http://mf-mm.gazi.edu.tr";
            else if (akdmsyn_giris.akademisyen_bolum == "Kimya Mühendisliği")
                url = "http://mf-km.gazi.edu.tr";
            else if (akdmsyn_giris.akademisyen_bolum == "Elektrik Elektronik Mühendisliği")
