...
{
    public partial class ogrisleri_anasayfa : Form
    {
        ...
        private void ogrisleri_anasayfa_Load(object sender, EventArgs e)
        {
            lblTitle.Text = "Hoş Geldiniz " + ogrisleri_giris.kullanici_ad_soyad;
            anamenuyedonme();
        }
        ...
        {
            Öğrenci_İşleri.ogrisleri_duyuru duyuruform = new Öğrenci_İşleri.ogrisleri_duyuru();
        ...
        private void buttonders_Click(object sender, EventArgs e)
        {
            alt_form_acma(new Öğrenci_İşleri.d_islemleri(), sender);
        }

        private void buttonogrenci_Click(object sender, EventArgs e)
        {
            alt_form_acma(new Öğrenci_İşleri.o_islemleri(), sender);
        }

        private void buttonakademisyen_Click(object sender, EventArgs e)
        {
            alt_form_acma(new Öğrenci_İşleri.a_islemleri(), sender);
        }

        private void buttonogris_Click(object sender, EventArgs e)
        {
            alt_form_acma(new Öğrenci_İşleri.oi_islemleri(), sender);
        }

        private void button1_Click(object sender, EventArgs e)
        {
            alt_form_acma(new Öğrenci_İşleri.ogrisleri_sifre(), sender);
        }
